...
static const u32 __attribute__ ((aligned (1024))) Te0_[256] = {
...
static const u32 __attribute__ ((aligned (1024))) Te1_[256] = {
...
static const u32 __attribute__ ((aligned (1024))) Te2_[256] = {
...
static const u32 __attribute__ ((aligned (1024))) Te3_[256] = {
...
int allocate_pages(int num, void **addresses){
    ...
    int pagesize = getpagesize();
    while(n0 < n || n1 < n){
		// uintptr_t addr = aligned_alloc(pagesize, pagesize);
